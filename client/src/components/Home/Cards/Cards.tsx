...
import SkeletonComponent from "../../utilities/skeletonLoading/cardsLoading/SkeletonComponent.cards";
        ...
        <div className="split">
          <div className="cardOne">
            ...
            <p>
              ...
              eius praesentium, earum commodi numquam sapiente!
            </p>
          </div>
          ...
          <div className="cardTwo">
            ...
            <p>
              ...
              ut alias, dolorum voluptatibus praesentium cum.
            </p>
          </div>
