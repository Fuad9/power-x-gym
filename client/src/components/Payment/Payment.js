...
//images
import circle from "../../images/radio_active.png";
import paypal from "../../images/Bitmap.png";
import card1 from "../../images/credit-cards_mastercard.png";
import card2 from "../../images/credit-cards_visa.png";
import card3 from "../../images/credit-cards_amex.png";
//styles
import "./Payment.scss";
   ...
   return (
      <>
         ...
         <section className="AppWrapper container">
            <div className="split">
               <div>
                  <h1 className="text-center">Payment Selection</h1>
